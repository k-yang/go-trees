...
func main() {
	...
	// merkleRoot := merkle.GenerateMerkleRoot(hashes)
	// generatedMerkleProof := merkle.GenerateMerkleProof(hashes[4], hashes)
	// merkleTree := merkle.GenerateMerkleTree(hashes)
	// merkleRootFromMerkleProof := merkle.GetMerkleRootFromMerkleProof(generatedMerkleProof)

	// fmt.Println("merkleRoot: ", merkleRoot)
	// fmt.Println("generatedMerkleProof: ", generatedMerkleProof)
	// fmt.Println("merkleTree: ", merkleTree)
	// fmt.Println("merkleRootFromMerkleProof: ", merkleRootFromMerkleProof)
	// fmt.Println("merkleRootFromMerkleProof === merkleRoot: ", merkleRootFromMerkleProof == merkleRoot)

	// ASCII encoding
	fmt.Println([]byte("41b637cfd9eb3e2f60f734f9ca44e5c1559c6f481d49d6ed6891f3e9a086ac78a8c0cce8bb067e91cf2766c26be4e5d7cfba3d3323dc19d08a834391a1ce5acf"))
	fmt.Println(merkle.SHA256([]byte("41b637cfd9eb3e2f60f734f9ca44e5c1559c6f481d49d6ed6891f3e9a086ac78a8c0cce8bb067e91cf2766c26be4e5d7cfba3d3323dc19d08a834391a1ce5acf")))

	// HEX encoding
	fmt.Println(merkle.HexStringToBytes("41b637cfd9eb3e2f60f734f9ca44e5c1559c6f481d49d6ed6891f3e9a086ac78a8c0cce8bb067e91cf2766c26be4e5d7cfba3d3323dc19d08a834391a1ce5acf"))
	fmt.Println(merkle.SHA256(merkle.HexStringToBytes("41b637cfd9eb3e2f60f734f9ca44e5c1559c6f481d49d6ed6891f3e9a086ac78a8c0cce8bb067e91cf2766c26be4e5d7cfba3d3323dc19d08a834391a1ce5acf")))
}
